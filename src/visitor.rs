...
pub trait Visit<'ast> {
    ...
    fn visit_generic_selection(&mut self, generic_selection: &'ast GenericSelection, span: &'ast Span) {
        visit_generic_selection(self, generic_selection, span)
    }

    fn visit_generic_association(&mut self, generic_association: &'ast GenericAssociation, span: &'ast Span) {
        visit_generic_association(self, generic_association, span)
    }

    fn visit_generic_association_type(&mut self, generic_association_type: &'ast GenericAssociationType, span: &'ast Span) {
        visit_generic_association_type(self, generic_association_type, span)
    }

    fn visit_member_expression(&mut self, member_expression: &'ast MemberExpression, span: &'ast Span) {
    ...
    fn visit_compound_literal(&mut self, compound_literal: &'ast CompoundLiteral, span: &'ast Span) {
    ...
    fn visit_unary_operator_expression(&mut self, unary_operator_expression: &'ast UnaryOperatorExpression, span: &'ast Span) {
    ...
    fn visit_binary_operator_expression(&mut self, binary_operator_expression: &'ast BinaryOperatorExpression, span: &'ast Span) {
        visit_binary_operator_expression(self, binary_operator_expression, span)
    }

    fn visit_conditional_expression(&mut self, conditional_expression: &'ast ConditionalExpression, span: &'ast Span) {
    ...
    fn visit_offset_designator(&mut self, offset_designator: &'ast OffsetDesignator, span: &'ast Span) {
    ...
    fn visit_declaration_specifier(&mut self, declaration_specifier: &'ast DeclarationSpecifier, span: &'ast Span) {
    ...
    fn visit_storage_class_specifier(&mut self, storage_class_specifier: &'ast StorageClassSpecifier, span: &'ast Span) {
    ...
    fn visit_ts18661_float_type(&mut self, ts18661_float_type: &'ast TS18661FloatType, span: &'ast Span) {
        visit_ts18661_float_type(self, ts18661_float_type, span)
    }

    fn visit_ts18661_float_format(&mut self, ts18661_float_format: &'ast TS18661FloatFormat, span: &'ast Span) {
    ...
    fn visit_struct_declaration(&mut self, struct_declaration: &'ast StructDeclaration, span: &'ast Span) {
    ...
    fn visit_specifier_qualifier(&mut self, specifier_qualifier: &'ast SpecifierQualifier, span: &'ast Span) {
        visit_specifier_qualifier(self, specifier_qualifier, span)
    }

    fn visit_struct_declarator(&mut self, struct_declarator: &'ast StructDeclarator, span: &'ast Span) {
    ...
    fn visit_alignment_specifier(&mut self, alignment_specifier: &'ast AlignmentSpecifier, span: &'ast Span) {
    ...
    fn visit_derived_declarator(&mut self, derived_declarator: &'ast DerivedDeclarator, span: &'ast Span) {
        visit_derived_declarator(self, derived_declarator, span)
    }

    fn visit_array_declarator(&mut self, array_declarator: &'ast ArrayDeclarator, span: &'ast Span) {
        visit_array_declarator(self, array_declarator, span)
    }

    fn visit_function_declarator(&mut self, function_declarator: &'ast FunctionDeclarator, span: &'ast Span) {
        visit_function_declarator(self, function_declarator, span)
    }

    fn visit_pointer_qualifier(&mut self, pointer_qualifier: &'ast PointerQualifier, span: &'ast Span) {
    ...
    fn visit_parameter_declaration(&mut self, parameter_declaration: &'ast ParameterDeclaration, span: &'ast Span) {
    ...
    fn visit_initializer_list_item(&mut self, initializer_list_item: &'ast InitializerListItem, span: &'ast Span) {
    ...
    fn visit_range_designator(&mut self, range_designator: &'ast RangeDesignator, span: &'ast Span) {
    ...
    fn visit_labeled_statement(&mut self, labeled_statement: &'ast LabeledStatement, span: &'ast Span) {
    ...
    fn visit_external_declaration(&mut self, external_declaration: &'ast ExternalDeclaration, span: &'ast Span) {
        visit_external_declaration(self, external_declaration, span)
    }

    fn visit_function_definition(&mut self, function_definition: &'ast FunctionDefinition, span: &'ast Span) {
    ...
    fn visit_gnu_extended_asm_statement(&mut self, gnu_extended_asm_statement: &'ast GnuExtendedAsmStatement, span: &'ast Span) {
...
pub fn visit_integer_suffix<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, integer_suffix: &'ast IntegerSuffix, span: &'ast Span) {
...
pub fn visit_float_format<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, float_format: &'ast FloatFormat, span: &'ast Span) {
    match float_format {
...
pub fn visit_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, expression: &'ast Expression, _span: &'ast Span) {
    match expression {
...
pub fn visit_generic_association<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, generic_association: &'ast GenericAssociation, _span: &'ast Span) {
...
pub fn visit_generic_association_type<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, generic_association_type: &'ast GenericAssociationType, _span: &'ast Span) {
...
pub fn visit_member_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, member_expression: &'ast MemberExpression, _span: &'ast Span) {
...
pub fn visit_call_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, call_expression: &'ast CallExpression, _span: &'ast Span) {
...
pub fn visit_unary_operator_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, unary_operator_expression: &'ast UnaryOperatorExpression, _span: &'ast Span) {
...
pub fn visit_cast_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, cast_expression: &'ast CastExpression, _span: &'ast Span) {
...
pub fn visit_binary_operator_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, binary_operator_expression: &'ast BinaryOperatorExpression, _span: &'ast Span) {
...
pub fn visit_conditional_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, conditional_expression: &'ast ConditionalExpression, _span: &'ast Span) {
...
pub fn visit_offset_of_expression<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, offset_of_expression: &'ast OffsetOfExpression, _span: &'ast Span) {
...
pub fn visit_offset_designator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, offset_designator: &'ast OffsetDesignator, _span: &'ast Span) {
...
pub fn visit_offset_member<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, offset_member: &'ast OffsetMember, _span: &'ast Span) {
    match offset_member {
...
pub fn visit_declaration<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, declaration: &'ast Declaration, _span: &'ast Span) {
...
pub fn visit_declaration_specifier<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, declaration_specifier: &'ast DeclarationSpecifier, _span: &'ast Span) {
    match declaration_specifier {
        DeclarationSpecifier::StorageClass(s) => visitor.visit_storage_class_specifier(&s.node, &s.span),
...
pub fn visit_init_declarator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, init_declarator: &'ast InitDeclarator, _span: &'ast Span) {
...
pub fn visit_ts18661_float_type<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, ts18661_float_type: &'ast TS18661FloatType, span: &'ast Span) {
...
pub fn visit_struct_field<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, struct_field: &'ast StructField, _span: &'ast Span) {
...
pub fn visit_specifier_qualifier<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, specifier_qualifier: &'ast SpecifierQualifier, _span: &'ast Span) {
...
pub fn visit_enumerator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, enumerator: &'ast Enumerator, _span: &'ast Span) {
...
pub fn visit_alignment_specifier<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, alignment_specifier: &'ast AlignmentSpecifier, _span: &'ast Span) {
...
pub fn visit_declarator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, declarator: &'ast Declarator, _span: &'ast Span) {
...
pub fn visit_declarator_kind<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, declarator_kind: &'ast DeclaratorKind, _span: &'ast Span) {
...
pub fn visit_derived_declarator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, derived_declarator: &'ast DerivedDeclarator, _span: &'ast Span) {
...
pub fn visit_pointer_qualifier<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, pointer_qualifier: &'ast PointerQualifier, _span: &'ast Span) {
...
pub fn visit_array_size<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, array_size: &'ast ArraySize, span: &'ast Span) {
    match array_size {
...
pub fn visit_parameter_declaration<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, parameter_declaration: &'ast ParameterDeclaration, _span: &'ast Span) {
...
pub fn visit_initializer<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, initializer: &'ast Initializer, _span: &'ast Span) {
    match initializer {
...
pub fn visit_initializer_list_item<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, initializer_list_item: &'ast InitializerListItem, _span: &'ast Span) {
...
pub fn visit_designator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, designator: &'ast Designator, _span: &'ast Span) {
    match designator {
...
pub fn visit_range_designator<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, range_designator: &'ast RangeDesignator, _span: &'ast Span) {
...
pub fn visit_if_statement<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, if_statement: &'ast IfStatement, _span: &'ast Span) {
...
pub fn visit_switch_statement<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, switch_statement: &'ast SwitchStatement, _span: &'ast Span) {
...
pub fn visit_while_statement<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, while_statement: &'ast WhileStatement, _span: &'ast Span) {
...
pub fn visit_do_while_statement<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, do_while_statement: &'ast DoWhileStatement, _span: &'ast Span) {
...
pub fn visit_label<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, label: &'ast Label, _span: &'ast Span) {
    match label {
...
pub fn visit_translation_unit<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, translation_unit: &'ast TranslationUnit) {
    for element in &translation_unit.0 {
        visitor.visit_external_declaration(&element.node, &element.span);
    }
}

pub fn visit_external_declaration<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, external_declaration: &'ast ExternalDeclaration, _span: &'ast Span) {
    match external_declaration {
        ...
        ExternalDeclaration::FunctionDefinition(f) => visitor.visit_function_definition(&f.node, &f.span)
    }
}

pub fn visit_function_definition<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, function_definition: &'ast FunctionDefinition, _span: &'ast Span) {
...
pub fn visit_extension<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, extension: &'ast Extension, span: &'ast Span) {
    match extension {
...
pub fn visit_gnu_extended_asm_statement<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, gnu_extended_asm_statement: &'ast GnuExtendedAsmStatement, _span: &'ast Span) {
...
pub fn visit_type_of<'ast, V: Visit<'ast> + ?Sized>(visitor: &mut V, type_of: &'ast TypeOf, _span: &'ast Span) {
    match type_of {
